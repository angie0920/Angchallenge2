...
from qualifier.utils.fileio import save_csv_data
...
def find_qualifying_loans(bank_data, credit_score, debt, income, loan, home_value):
    ...
    ## create empty qualifying loans list:
    qualifying_loans = []
    print(f"Found {len(bank_data_filtered)} qualifying loans")
    ## exit if no qualifying loans, else append qualifying loans list
